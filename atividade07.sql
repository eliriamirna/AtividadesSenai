...
qtdCartoes,nomeCartao,numCartao,bandeira,validade,codSeguranca,valor)values(
"1","Eliria Mirna","1234 5678 9123 4567","elo","2023/01/01","753","49.90");
insert into pagamento(
qtdCartoes,nomeCartao,numCartao,bandeira,validade,codSeguranca,valor)values(
"2","Hugo Alfredo","9876 6541 3217 1599","visa","2024/02/01","951","49.90");
insert into pagamento(
qtdCartoes,nomeCartao,numCartao,bandeira,validade,codSeguranca,valor)values(
"1","Josué Júnior","7418 5296 3741 8529","mastercard","2025/03/01","741","49.90");
insert into pagamento(
qtdCartoes,nomeCartao,numCartao,bandeira,validade,codSeguranca,valor)values(
"2","Felipe Reis","3692 5814 7369 2581","hipercard","2026/04/01","789","49.90");
insert into pagamento(
qtdCartoes,nomeCartao,numCartao,bandeira,validade,codSeguranca,valor)values(
"1","Lygiane Martins","9515 9159 1591 5915","dinners club","2027/05/01","357","49.90");

insert into dadosPessoais(
nome,cpf,peso,idade,dataNasc,altura,problemaSaude,limitacoes)values(
"Elíria Mirna","123.456.789.10","60.30","26","1993/11/14","1.68","rinite","muito peso");
insert into dadosPessoais(
nome,cpf,peso,idade,dataNasc,altura,problemaSaude,limitacoes)values(
"Hugo Alfredo","123.456.789.11","70.40","25","1994/06/05","1.78","nenhum","nenhum");
insert into dadosPessoais(
nome,cpf,peso,idade,dataNasc,altura,problemaSaude,limitacoes)values(
"Josué Júnior","123.456.789.12","80.30","25","1994/09/21","1.93","rinite e pressão alta","nenhum");
insert into dadosPessoais(
nome,cpf,peso,idade,dataNasc,altura,problemaSaude,limitacoes)values(
"Felipe Reis","123.456.789.13","80.30","33","1987/01/23","1.83","diabetes","nenhum");
insert into dadosPessoais(
nome,cpf,peso,idade,dataNasc,altura,problemaSaude,limitacoes)values(
"Lygiane Martins","123.456.789.14","50.30","25","1994/07/08","1.58","sofreu acidente na perna","treinos com muito impcato");

insert into treino(
nome,cpf,inicio,objetivoTreino,frequenciaSemanal,horaTreino,duracaoTreinomin,modalidade)values(
"Elíria Mirna","123.456.789.10","2020/09/28","Melhorar flexiblidade e alongamento","5","08:00","30.00","yoga");
insert into treino(
nome,cpf,inicio,objetivoTreino,frequenciaSemanal,horaTreino,duracaoTreinomin,modalidade)values(
"Hugo Alfredo","123.456.789.11","2020/03/15","Perder massa gorda e definir músculos","7","10:00","60.00","zumba");
insert into treino(
nome,cpf,inicio,objetivoTreino,frequenciaSemanal,horaTreino,duracaoTreinomin,modalidade)values(
"Josué Júnior","123.456.789.12","2020/06/12","Ganhar massa magra","4","06:00","45.00","musculaçao");
insert into treino(
nome,cpf,inicio,objetivoTreino,frequenciaSemanal,horaTreino,duracaoTreinomin,modalidade)values(
"Felipe Reis","123.456.789.13","2020/05/01","Perder peso","3","17:00","90.00","cross fit");
insert into treino(
nome,cpf,inicio,objetivoTreino,frequenciaSemanal,horaTreino,duracaoTreinomin,modalidade)values(
"Lygiane Martins","123.456.789.14","2020/02/10","treinar auto defesa","2","18:00","40.00","karatê");
